...
#         (change_screen_return),
      ...
      ("tutorial_cheat",[(eq,1,0)],"{!}CHEAT!",
       [
         ...
         (party_add_members, "p_main_party", "trp_jhg_freeman", 10),
         (party_add_members, "p_main_party", "trp_jhg_freeman", 10),
      ...
      "Take a walk around the streets.",
       [
         ...
         (else_try),
           ...
           (else_try),
             (assign,reg0,"trp_jhg_freeman"),
             (assign,reg1,"trp_jhg_freeman"),
             (assign,reg2,"trp_jhg_freeman"),
             (assign,reg3,"trp_jhg_freeman"),
           (try_end),
           (shuffle_range,0,4),
