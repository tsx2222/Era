...
# Reinforcements
  ...
  ("kingdom_2_reinforcements_a", "{!}kingdom_2_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_jhg_freeman,5,10),(trp_jhg_freeman,2,4)]),
  ("kingdom_2_reinforcements_b", "{!}kingdom_2_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_jhg_freeman,2,4),(trp_jhg_freeman,2,4),(trp_jhg_freeman,1,2)]),
  ("kingdom_2_reinforcements_c", "{!}kingdom_2_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_jhg_freeman,2,3),(trp_jhg_freeman,1,2)]),

  ("kingdom_3_reinforcements_a", "{!}kingdom_3_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_hg_wushi,1,3),(trp_hg_changdao,2,4),(trp_hg_gongjian,1,3),(trp_hg_footman,2,4),(trp_yg_qishe,1,3),(trp_tg_wushi,1,2)]), #Khergits are a bit less-powered thats why they have a bit more 2nd upgraded(trp_khergit_skirmisher) than non-upgraded one(trp_khergit_tribesman).
  ("kingdom_3_reinforcements_b", "{!}kingdom_3_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_hg_xuanfeng,1,2),(trp_hg_yufeng,1,3),(trp_yg_zhongjia,1,2),(trp_hg_zhongqi,2,5),(trp_tg_xuelang,2,3),(trp_tg_youqi,1,2)]),
  ("kingdom_3_reinforcements_c", "{!}kingdom_3_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_hg_daosheng,1,2),(trp_hg_daoke,1,3),(trp_hg_chong,1,2,),(trp_yg_shediao,1,2),(trp_hg_futu,0,1),(trp_hg_canglang,0,1)]), #Khergits are a bit less-powered thats why they have a bit more troops in their modernised party template (4-7, others 3-5)
